...
namespace MCDSaveEditor.Models
{
    public class StringLibrary : Properties.Resources
    {
        private static readonly Dictionary<string, string> _mismatches = new CaseInSensitiveDictionary<string, string>() {
            ...
            { "Flavour_HighlanderLongSword","Unset" }, //Missing
            { "LongBow","Longbow" },
        ...
        private static Dictionary<string, string> _mission = new CaseInSensitiveDictionary<string, string>();
        private static Dictionary<string, string> _clickys = new CaseInSensitiveDictionary<string, string>();
